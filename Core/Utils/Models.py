...
def build_model(model_name, num_class, input_channel=1,pretrained=False, **kwargs):
    if model_name == "resnet10":
        return resnet10(n_input_channels=input_channel, num_classes=num_class, widen_factor=1,**kwargs)
