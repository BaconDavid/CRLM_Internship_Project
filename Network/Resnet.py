...
class ResNetBlock(nn.Module):
    ...
    def __init__(
        ...
        self.drop_out = nn.Dropout3d(p=self.drop_rate)
...
def resnet10(pretrained: bool = False, progress: bool = True, block_inplanes=None,**kwargs: Any) -> ResNet:
    ...
    """
    return _resnet("resnet10", ResNetBlock,[1, 1, 1, 1], block_inplanes,pretrained, progress, **kwargs)
